    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-4">
                <div v-if="openForm"
                    class="flex items-center justify-center bg-white bg-opacity-40 fixed top-0 left-0 right-0 bottom-0 z-20">
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100 flex items-center justify-center">
                            <div class=" space-y-3 w-full max-w-4xl ">
                                <div class="flex items-center justify-end">
                                    <button class="cursor-pointer" @click="openForm = false">
                                ...
                                <div class="flex items-center justify-between">
                                    <button @click="form.featured = form.featured == 1 ? 0 : 1"
                                        class="bg-white cursor-pointer border border-gray-100 p-2 rounded-md px-4"
                ...
                <div class="bg-white shadow-md p-5 rounded-md">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="border border-gray-200 p-2 cursor-pointer rounded-md" v-for="note in featured_notes" :key="note.id"
                            :style="note.bg_color ? { backgroundColor: note.bg_color } : {}" @click="openEditModal(note)">
                ...
                <div class="bg-white shadow-md p-5 rounded-md">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="border border-gray-200 p-2 cursor-pointer rounded-md" v-for="note in all_notes" :key="note.id"
                            :style="note.bg_color ? { backgroundColor: note.bg_color } : {}" @click="openEditModal(note)">
